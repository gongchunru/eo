  ...
  <body topmargin="0" bottommargin="0">
	...
	<table width="100%" height="500" cellspacing="0"  border="0">
	  ...
	  <td valign="top" width="155"  class="main_left">
		...
		<br>
		<br>
		<form method="post" name="reg" action="modifyExamPaper" >
		<table cellpadding="3" cellspacing="1" align="center" class="tableborder1" id="table1">
	
		 <tr>
		 <td align="center" colspan="2" background="<%=path %>/images/bg_table.gif"><b><font size="3" color="white">修改试卷</font></b></td>
		 </tr>

		<tr>
			<td width="33%" class="tablebody1"><b>试卷名</b>：</td>
			<td width="77%" class="tablebody2">
			<table>
			<tr>
			<td><input type="text" size="25" maxlength="16" name="examPaper.name" value="${examPaper.name}" id="nameID" />
		...
		<tr>
			<td width="33%" class="tablebody1"><b>考试总时长</b>：</td>
			<td width="77%"class="tablebody2">
			<input type="text" size="25" maxlength="16" name="examPaper.totalTime" value="${examPaper.totalTime }" id="totalTimeID"/>
		...
		<tr>
			...
			<input type="hidden" size="25" maxlength="16" name="examPaper.epid" value="${examPaper.epid }" />

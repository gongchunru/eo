  ...
  <body topmargin="0" bottommargin="0">
	...
	<table width="100%" height="500" cellspacing="0"  border="0">
	  ...
	  <td valign="top" width="155"  class="main_left">
		...
		<br>
		<br>
		<form method="post" name="reg" action="modifyQuestion">
		...
		<tr>
			...
			<select name="type">
				<option value="1" <c:if test="${question.type ==1 }">selected</c:if>>单选</option>
				<option value="2" <c:if test="${question.type ==2 }">selected</c:if>>多选</option>
			</select>
			<!-- 
			<select name="type">
		...
		<tr>
			...
			<td class="tablebody2">
			<textarea rows="5" cols="60" name="content" id="contentID">${question.content }</textarea>

	...
	<table width="100%" height="500" cellspacing="0"  border="0">
	  ...
	  <td valign="top" width="155"  class="main_left">
		...
		<table cellpadding="3" cellspacing="1" align="center" class="tableborder1" id="table1">
		 ...
		 <tr>
		 <td align="center" colspan="2" background="<%=path %>/images/bg_table.gif"><b><font size="3" color="white">个人详细信息</font></b></td>
		 </tr>
		...
		<tr>
			...
			<td width="60%"class="tablebody2">
			<c:out value="">${SessionScope.student.sex}</c:out>
